...
- A universal `/search` route that aggregates anime/manga/characters with category chips, shareable URL state, empty/error handling, and retry/backoff messaging when AniList hiccups.
